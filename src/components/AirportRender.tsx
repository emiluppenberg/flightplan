    ...
    return (
        <div className="airport-render-container">
            <div className="airport-data-container">
                <h4>{props.airport.icaoId.toUpperCase()}</h4>
                {props.airport.TAF.length > 0 && props.airport.TAF.map((taf, index) => (
                    <ReportRender
                ...
                {props.airport.METAR.length > 0 && props.airport.METAR.map((metar, index) => (
                    <ReportRender
